...
`timescale 1 ns / 1 ps
	...
	(
        ...
        output [11:0] color_in, // Pixel color data (RRRRGGGGBBB)
...
// Instantiation of Axi Bus Interface S00_AXI
	VGA_Display_v1_1_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) VGA_Display_v1_1_S00_AXI_inst (
	...
	// Add user logic here
	timediv time_div_inst
	(
	.clk_100(s00_axi_aclk),
	.clk_25(clk_25)
	);
    vga_display vga_display_inst
    (
        .clk(clk_25),     // 25 MHz
        .rst_n(s00_axi_aresetn),     // Active high
        .color_in(color_in), // Pixel color data (RRRRGGGGBBB)
