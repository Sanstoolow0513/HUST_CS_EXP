...
-- Date        : Thu Dec 19 18:50:05 2024
-- Host        : DESKTOP-KBVQ20U running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/continex/RVfpgaSoC/RVfpgaSoC.srcs/sources_1/bd/swerv_soc/ip/swerv_soc_my_voice_0_0/swerv_soc_my_voice_0_0_sim_netlist.vhdl
...
entity swerv_soc_my_voice_0_0_my_voice_controller is
  port (
  ...
  attribute ORIG_REF_NAME of swerv_soc_my_voice_0_0_my_voice_controller : entity is "my_voice_controller";
end swerv_soc_my_voice_0_0_my_voice_controller;

architecture STRUCTURE of swerv_soc_my_voice_0_0_my_voice_controller is
  ...
  signal NLW_cnt2_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \NLW_cnt2_carry__3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_cnt2_carry__3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
...
\AUD_PWM0_carry__0_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1017170117170701"
    )
        port map (
      I0 => cnt(14),
      I1 => cnt(15),
...
\AUD_PWM0_carry__0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7017731773770117"
    )
        port map (
      I0 => cnt(12),
      I1 => cnt(13),
...
\AUD_PWM0_carry__0_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1113713317771111"
    )
        port map (
      I0 => cnt(10),
      I1 => cnt(11),
...
\AUD_PWM0_carry__0_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00154000543FD555"
    )
        port map (
      I0 => cnt(8),
      I1 => \state_reg_n_0_[0]\,
...
\AUD_PWM0_carry__0_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0220222098868846"
    )
        port map (
      I0 => cnt(14),
      I1 => \state_reg_n_0_[3]\,
...
\AUD_PWM0_carry__0_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"82929A0218080068"
    )
        port map (
      I0 => cnt(12),
      I1 => \state_reg_n_0_[2]\,
...
\AUD_PWM0_carry__0_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"01852A00A82080AA"
    )
        port map (
      I0 => cnt(10),
      I1 => \state_reg_n_0_[0]\,
...
\AUD_PWM0_carry__0_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"002A8000A9402AAA"
    )
        port map (
      I0 => cnt(8),
      I1 => \state_reg_n_0_[0]\,
...
\AUD_PWM0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \AUD_PWM0_carry__1_i_1_n_0\,
      O(3 downto 0) => \NLW_AUD_PWM0_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \AUD_PWM0_carry__1_i_2_n_0\,
      S(2) => \AUD_PWM0_carry__1_i_3_n_0\,
      S(1) => \AUD_PWM0_carry__1_i_4_n_0\,
      S(0) => \AUD_PWM0_carry__1_i_5_n_0\
    );
\AUD_PWM0_carry__1_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000054454445"
    )
        port map (
      I0 => cnt(16),
      I1 => \state_reg_n_0_[3]\,
...
\AUD_PWM0_carry__1_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000EBAB1454"
    )
        port map (
      I0 => \state_reg_n_0_[3]\,
      I1 => \state_reg_n_0_[2]\,
...
\cnt1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \cnt2_carry__3_n_1\,
      S(2) => \cnt2_carry__3_n_1\,
      S(1) => \cnt1_carry__2_i_5_n_0\,
      S(0) => \cnt1_carry__2_i_6_n_0\
    );
...
cnt1_carry_i_8: unisim.vcomponents.LUT3
    generic map(
      INIT => X"82"
    )
        port map (
...
cnt2_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      O(0) => NLW_cnt2_carry_O_UNCONNECTED(0),
...
\cnt2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(2) => '1',
      DI(1) => \cnt2_carry__0_i_2_n_0\,
      DI(0) => '1',
      O(3 downto 0) => cnt2(7 downto 4),
      S(3) => \cnt2_carry__0_i_3_n_0\,
      S(2) => \cnt2_carry__0_i_4_n_0\,
      S(1) => \cnt2_carry__0_i_5_n_0\,
      S(0) => \cnt2_carry__0_i_6_n_0\
    );
...
\cnt2_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '1',
      DI(2) => \cnt2_carry__1_i_1_n_0\,
      DI(1) => '1',
      DI(0) => \cnt2_carry__1_i_2_n_0\,
      O(3 downto 0) => cnt2(11 downto 8),
      S(3) => \cnt2_carry__1_i_3_n_0\,
      S(2) => \cnt2_carry__1_i_4_n_0\,
      S(1) => \cnt2_carry__1_i_5_n_0\,
      S(0) => \cnt2_carry__1_i_6_n_0\
    );
\cnt2_carry__1_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4222"
    )
        port map (
...
\cnt2_carry__1_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2206"
    )
        port map (
...
\cnt2_carry__1_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"002A"
    )
        port map (
...
\cnt2_carry__1_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F87F"
    )
        port map (
...
\cnt2_carry__1_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0820"
    )
        port map (
...
\cnt2_carry__1_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F4EF"
    )
        port map (
...
\cnt2_carry__2_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2444"
    )
        port map (
...
\cnt2_carry__2_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1B90"
    )
        port map (
...
\cnt2_carry__2_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0A28"
    )
        port map (
...
\cnt2_carry__2_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D9B1"
    )
        port map (
...
\cnt2_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_cnt2_carry__3_CO_UNCONNECTED\(3),
      CO(2) => \cnt2_carry__3_n_1\,
      CO(1) => \NLW_cnt2_carry__3_CO_UNCONNECTED\(1),
      CO(0) => \cnt2_carry__3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0011",
      O(3 downto 2) => \NLW_cnt2_carry__3_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => cnt2(17 downto 16),
      S(3 downto 2) => B"01",
      S(1) => \cnt2_carry__3_i_1_n_0\,
      S(0) => \cnt2_carry__3_i_2_n_0\
    );
\cnt2_carry__3_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"007C"
    )
        port map (
...
\cnt2_carry__3_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF83"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity swerv_soc_my_voice_0_0_my_voice_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of swerv_soc_my_voice_0_0_my_voice_v1_0_S00_AXI : entity is "my_voice_v1_0_S00_AXI";
end swerv_soc_my_voice_0_0_my_voice_v1_0_S00_AXI;

architecture STRUCTURE of swerv_soc_my_voice_0_0_my_voice_v1_0_S00_AXI is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity swerv_soc_my_voice_0_0_my_voice_v1_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of swerv_soc_my_voice_0_0_my_voice_v1_0 : entity is "my_voice_v1_0";
end swerv_soc_my_voice_0_0_my_voice_v1_0;

architecture STRUCTURE of swerv_soc_my_voice_0_0_my_voice_v1_0 is
  signal my_voice_v1_0_S00_AXI_inst_n_1 : STD_LOGIC;
begin
my_voice_controller: entity work.swerv_soc_my_voice_0_0_my_voice_controller
     port map (
      AUD_PWM => AUD_PWM,
      SR(0) => my_voice_v1_0_S00_AXI_inst_n_1,
      s00_axi_aclk => s00_axi_aclk
    );
my_voice_v1_0_S00_AXI_inst: entity work.swerv_soc_my_voice_0_0_my_voice_v1_0_S00_AXI
     port map (
      SR(0) => my_voice_v1_0_S00_AXI_inst_n_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity swerv_soc_my_voice_0_0 is
  port (
    AUD_PWM : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of swerv_soc_my_voice_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of swerv_soc_my_voice_0_0 : entity is "swerv_soc_my_voice_0_0,my_voice_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of swerv_soc_my_voice_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of swerv_soc_my_voice_0_0 : entity is "my_voice_v1_0,Vivado 2019.2";
end swerv_soc_my_voice_0_0;

architecture STRUCTURE of swerv_soc_my_voice_0_0 is
...
inst: entity work.swerv_soc_my_voice_0_0_my_voice_v1_0
     port map (
      AUD_PWM => AUD_PWM,
      enable(31 downto 1) => \^enable\(31 downto 1),
      enable(0) => \^aud_sd\,
