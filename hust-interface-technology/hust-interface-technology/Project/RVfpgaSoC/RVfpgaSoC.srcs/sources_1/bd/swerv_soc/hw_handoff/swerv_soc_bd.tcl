...
# module references:
# bootrom_wrapper, syscon_wrapper, wb_spi_wrapper, wb_uart_wrapper
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {rst_0:m_rst} \
 ] $clk_0
  ...
  set i_accel_miso [ create_bd_port -dir I i_accel_miso ]
  ...
  set o_accel_cs_n [ create_bd_port -dir O o_accel_cs_n ]
  set o_accel_mosi [ create_bd_port -dir O o_accel_mosi ]
  set o_accel_sclk [ create_bd_port -dir O o_accel_sclk ]
  ...
  set sd_sw [ create_bd_port -dir I sd_sw ]
  ...
  # Create instance: my_mic_0, and set properties
  set my_mic_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_mic:2.1 my_mic_0 ]

  # Create instance: my_voice_0, and set properties
  set my_voice_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_voice:2.0 my_voice_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins my_mic_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins my_voice_0/S00_AXI]
  ...
  connect_bd_net -net MIC_DATA_0_1 [get_bd_ports MIC_DATA] [get_bd_pins my_mic_0/MIC_DATA]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins PWM_w_Int_0/s00_axi_aclk] [get_bd_pins axi2wb_intcon_wrapper_0/clk_i_wrapper] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins bootrom_wrapper_0/i_clk] [get_bd_pins my_mic_0/clk] [get_bd_pins my_mic_0/s00_axi_aclk] [get_bd_pins my_voice_0/s00_axi_aclk] [get_bd_pins swerv_wrapper_verilog_0/clk] [get_bd_pins syscon_wrapper_0/i_clk] [get_bd_pins wb_gpio_wrapper_0/wb_clk_i] [get_bd_pins wb_spi_wrapper_0/wb_clk_i] [get_bd_pins wb_uart_wrapper_0/wb_clk_i]
  ...
  connect_bd_net -net i_accel_miso_0_1 [get_bd_ports i_accel_miso] [get_bd_pins wb_spi_wrapper_0/i_accel_miso]
  ...
  connect_bd_net -net wb_spi_wrapper_0_o_accel_cs_n [get_bd_ports o_accel_cs_n] [get_bd_pins wb_spi_wrapper_0/o_accel_cs_n]
  connect_bd_net -net wb_spi_wrapper_0_o_accel_mosi [get_bd_ports o_accel_mosi] [get_bd_pins wb_spi_wrapper_0/o_accel_mosi]
  connect_bd_net -net wb_spi_wrapper_0_o_accel_sclk [get_bd_ports o_accel_sclk] [get_bd_pins wb_spi_wrapper_0/o_accel_sclk]
  ...
  assign_bd_address -offset 0x80200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi2wb_intcon_wrapper_0/o_user_axi4] [get_bd_addr_segs my_mic_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x80140000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi2wb_intcon_wrapper_0/o_user_axi4] [get_bd_addr_segs my_voice_0/S00_AXI/S00_AXI_reg] -force
