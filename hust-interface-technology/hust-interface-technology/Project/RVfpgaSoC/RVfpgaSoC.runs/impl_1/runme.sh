...
HD_PWD='C:/continex/RVfpgaSoC/RVfpgaSoC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rvfpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rvfpga.tcl -notrace
