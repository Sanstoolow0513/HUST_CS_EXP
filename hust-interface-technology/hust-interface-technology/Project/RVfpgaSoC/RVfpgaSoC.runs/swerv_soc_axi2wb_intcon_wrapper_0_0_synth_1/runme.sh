...
HD_PWD='C:/inter_p/RVfpgaSoC/RVfpgaSoC.runs/swerv_soc_axi2wb_intcon_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swerv_soc_axi2wb_intcon_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swerv_soc_axi2wb_intcon_wrapper_0_0.tcl
