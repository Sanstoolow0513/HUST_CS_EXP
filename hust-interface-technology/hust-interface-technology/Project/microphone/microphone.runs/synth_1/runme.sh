...
HD_PWD='C:/continex/microphone/microphone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microphone.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microphone.tcl
