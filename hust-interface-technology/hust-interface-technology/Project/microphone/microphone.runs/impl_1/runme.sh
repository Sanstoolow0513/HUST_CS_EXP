...
HD_PWD='C:/continex/microphone/microphone.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microphone.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microphone.tcl -notrace
